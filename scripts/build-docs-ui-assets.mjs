...
await copySupportAsset('dist/docs/ui/runtime/sidebar-tree.js', 'sidebar-tree.js')
await copySupportAsset('dist/docs/ui/runtime/code-block-toolbar.js', 'code-block-toolbar.js')
